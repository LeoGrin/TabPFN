...
class TransformerModel2(nn.Module):
    def __init__(self, encoder, n_out, ninp, nhead, nhid, nlayers, dropout=0.0, style_encoder=None, y_encoder=None,
                 ...
                 all_layers_same_init=False, efficient_eval_masking=True, transformer_type="classic"):
        super().__init__()
        ...
        #     encoder_layer_creator = lambda: NystromformerModel(NystromformerConfig(ninp, nhead, nhid, dropout, activation=activation,
        #                                                             pre_norm=pre_norm, recompute_attn=recompute_attn))
        if transformer_type == "classic":
